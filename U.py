...
def o():
    ...
    print("""\033[1;32mRANDOM NUMBER CRACK
     ...
     SEX :)FREE RANDOM""")
    jalan('\x1b[1;32m [A]\x1b[1;33m RANDOM CRACK slow ')
    jalan('\x1b[1;32m [B]\x1b[1;33m RANDOM CRACK ')
    jalan('\x1b[1;32m [C]\x1b[1;33m RANDOM CRACK')
    jalan('\x1b[1;32m [D] \x1b[1;32mCONTACT ME ON FACEBOOK')
    jalan(' \x1b[1;32m[E] \x1b[1;31mEXIT')
    opt = input('\n   \x1b[1;32m Choose option >>> ')
    if opt == 'A':
        i()
        return None
